...
const bool Checksec::isASLR() const
{
    ...
    return (!(imageCharacteristics_ & IMAGE_FILE_RELOCS_STRIPPED) && isDynamicBase()) || isDotNET();
}
...
const bool Checksec::isRFG() const
{
    ...
    return (loadConfigGuardFlags_ & 0x00020000) && (loadConfigGuardFlags_ & 0x00040000 || loadConfigGuardFlags_ & 0x00080000);
}
